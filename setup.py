...
"""Setup script for packaging eca_excel_openpyxl.
...
import json
src_file = os.path.join(here, "eca_excel_openpyxl", ".constants.json")
...
setup(name='eca_excel_openpyxl',
    packages=find_packages(),
    # metadata
    version=__version__,
    description="A simple wrapper example from openpyxl",
    ...
    package_data={
        'eca_excel_openpyxl': ['.constants.json']
    },
    classifiers=[
